...
<template>
  ...
  <div
    class="mx-[10vw] sm:mx-20 xl:mx-52 mt-[25vw] sm:mt-40 relative grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[40vw] sm:gap-[15vw] xl:gap-[8vw] xl:grid-cols-4"
  >
    <NuxtLink
